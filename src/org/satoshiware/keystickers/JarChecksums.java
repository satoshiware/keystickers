...
public class JarChecksums {
    public static int FILESCHECKED = 16; // Doesn't include the Keysticker jar file
    ...
    private static String jarFiles(int index, String item) {
        ...
        switch (index) {
            ...
            case 16:    file = "slf4j-api-1.7.12.jar";      spacing += 0;   checksum = "0aee9a77a4940d72932b0d0d9557793f872e66a03f598e473f45e7efecdccf99";  description = "Simple Logging Facade for Java (SLF4J.org) API"; break;
